...
class IpLocalizationCountryCodeServiceImpl extends APIServiceBase
  ...
  Future<APIResponse<IpLocalization>> getIpLoclization(String? ip) {
    if (ip == null) {
      return get<IpLocalization>('http://ip-api.com/json',
          (dynamic json) => IpLocalization.fromJson(json));
    }
    return get<IpLocalization>('http://ip-api.com/json/$ip',
        (dynamic json) => IpLocalization.fromJson(json));
  }
}
