...
class RespondentDataServiceImpl extends APIServiceBase
  ...
  Future<APIResponse<RespondentDataDto>> create(CreateRespondentDataDto dto) {
    return postAndDeserialize<RespondentDataDto>('/api/respondents',
        dto.toJson(), (dynamic json) => RespondentDataDto.fromJson(json));
  }

  @override
  Future<APIResponse<RespondentDataDto>> getRespondentData() =>
      get<RespondentDataDto>('/api/respondents',
